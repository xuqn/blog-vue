<template>
  <div class="user">
  	...
  	<section class="article">
  		<div class="item" v-for="blog in blogs" @click="goTodetail(blog.id)">
  			<div class="date">
...
export default {
	...
	methods: {
		handleCurrentChange(val) {
			...
			blog.getBlogsByUserId(this.$route.params.userId,{ page: this.currentPage })
			.then(res => {
				this.blogs = res.data
				this.total = res.total
				if (res.data.length>0) {
